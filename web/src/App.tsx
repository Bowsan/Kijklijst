      ...
      {tab === 'list' && (
        searchOpen ? (
          ...
          <>
            ...
            <button className="fab-search" aria-label="Zoek of voeg toe" onClick={() => { setShowAddHint(false); setNameFilter(''); setSearchOpen(true); }}>
              <svg className="fab-plus" width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.6" strokeLinecap="round" aria-hidden="true">
